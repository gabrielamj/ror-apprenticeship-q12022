...
ActiveRecord::Schema.define(version: 20_220_125_190_639) do
  ...
  create_table 'abilities_pokemons', id: false, force: :cascade do |t|
    ...
    t.index %w[ability_id pokemon_id], name: 'index_abilities_pokemons_on_ability_id_and_pokemon_id'
  end
  ...
  create_table 'pokemons_poketypes', id: false, force: :cascade do |t|
    ...
    t.index %w[pokemon_id poketype_id], name: 'index_pokemons_poketypes_on_pokemon_id_and_poketype_id'
  end

  create_table 'pokemons_trainers', id: false, force: :cascade do |t|
    t.integer 'trainer_id'
    t.integer 'pokemon_id'
    t.index %w[trainer_id pokemon_id], name: 'index_pokemons_trainers_on_trainer_id_and_pokemon_id'
  end
